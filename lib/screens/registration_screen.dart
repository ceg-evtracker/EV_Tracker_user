  ...
  Widget build(BuildContext context) {
    ...
    final firstNameField = TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.account_circle, color: Color.fromARGB(255, 32, 32, 32),),
    ...
    final confirmPasswordField = TextFormField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            ...
            icon: _isVisible1 ? Icon(Icons.visibility,color:Color.fromARGB(255, 32, 32, 32)) : Icon(Icons.visibility_off,color: Color.fromARGB(255, 32, 32, 32)),
          ),
          contentPadding: EdgeInsets.fromLTRB(20, 15, 20, 15),
    ...
    return Stack(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Color.fromARGB(255, 32, 32, 32)),
          onPressed: () {
